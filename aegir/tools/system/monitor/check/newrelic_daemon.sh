...
# =============================================================================
# newrelic_daemon.sh — New Relic APM daemon watchdog for BOA
# Split from: proc_num_ctrl.pl (legacy Perl service monitor)
#
# Restarts the New Relic application daemon when it is not running and the init
# script exists. Equivalent to the legacy line:
#   system("service newrelic-daemon restart")
#     if (!$newrelicdaemonsumar && -f "/etc/init.d/newrelic-daemon");
#
