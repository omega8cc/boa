...
# crawlers, Bingbot, Pingdom, UptimeRobot, BugBug, Imperva, Sucuri, Auth0,
# Site24x7, and local addresses. The monitor must honour that single source
# of truth rather than maintain its own list.
#
...
# Google's special-case crawlers, Bingbot, Pingdom, UptimeRobot, BugBug,
# Imperva, Sucuri, Auth0, Site24x7, local addresses, ...).
#
