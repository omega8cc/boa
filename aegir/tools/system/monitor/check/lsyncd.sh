...
# =============================================================================
# lsyncd.sh — Lsyncd service watchdog for BOA
# Split from: proc_num_ctrl.pl (legacy Perl service monitor)
#
# Starts lsyncd when it is not running and the init script exists.
...
if [ -f "/etc/init.d/lsyncd" ] && ! pgrep -x lsyncd >/dev/null 2>&1; then
