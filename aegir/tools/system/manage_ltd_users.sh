...
disable_chattr () {
  if [ ! -z "$1" ] && [ -d "/home/$1" ] ; then
    ...
    if [ "$1" != "${_OWN}.ftp" ] ; then
      ...
      if [ ! -d "/data/disk/${_OWN}/.drush/usr/drupalgeddon" ] || [ ! -e "/data/disk/${_OWN}/static/control/.drupalgeddon.in.011.pid" ] ; then
        ...
        touch /data/disk/${_OWN}/static/control/.drupalgeddon.in.011.pid
      fi
      if [ ! -L "/home/$1/.drush/usr/drupalgeddon" ] && [ -d "/data/disk/${_OWN}/.drush/usr/drupalgeddon" ] ; then
