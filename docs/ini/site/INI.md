...
;;  never capped.
;;
;;  Set 0 to disable the cap for this site. A site whose database lives on a
;;  MariaDB server needs 0, because MariaDB does not know max_execution_time
;;  and rejects the statement, which makes every web request fail with a 500.
;;
