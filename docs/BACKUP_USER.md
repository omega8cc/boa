...
- New PRO Backups for Octopus Lshell User (this document) [docs/BACKUP_USER.md](https://github.com/omega8cc/boa/tree/5.x-pro/docs/BACKUP_USER.md)
...
**Note**: Replace `your_username` with your actual Aegir **system** username (not lshell/FTP username) in all examples above.
