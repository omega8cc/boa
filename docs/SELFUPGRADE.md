...
Note that this PID file will be ignored if there is no `platforms.info` file, as explained in [PLATFORMS.md](https://github.com/omega8cc/boa/tree/5.x-lts/docs/PLATFORMS.md).
...
_AUTO_PHP=        # Force php-min, php-all, or php-max; otherwise ignored
```
