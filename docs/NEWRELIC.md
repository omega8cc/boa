...
See also [more details in platform/INI.md docs](https://github.com/omega8cc/boa/blob/5.x-lts/docs/ini/platform/INI.md)
...
See also [more details in site/INI.md docs](https://github.com/omega8cc/boa/blob/5.x-lts/docs/ini/site/INI.md)
