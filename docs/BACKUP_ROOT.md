...
- New PRO Backups for BOA SysAdmin (this document) [docs/BACKUP_ROOT.md](https://github.com/omega8cc/boa/tree/5.x-pro/docs/BACKUP_ROOT.md)
...
- New PRO Backups Supported Regions and Bucket Creation Guidelines [docs/BACKUP_REGIONS.md](https://github.com/omega8cc/boa/tree/5.x-pro/docs/BACKUP_REGIONS.md)
...
Restoring global backups follows the same logic as [user backups](https://github.com/omega8cc/boa/tree/5.x-pro/docs/BACKUP_USER.md), except administrators manage the entire system. Use the `multiback` command for global restores:
...
For user-specific backups, refer to the separate [**User Backup Guide**](https://github.com/omega8cc/boa/tree/5.x-pro/docs/BACKUP_USER.md)
