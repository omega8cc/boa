...
22. MultiCore Apache Solr 9, Solr 7, and Solr 4 (See [docs/SOLR.md](https://github.com/omega8cc/boa/tree/5.x-lts/docs/SOLR.md) for details). Solr 9 is the current/forward option; Solr 7 and Solr 4 are not supported on Devuan Excalibur.
