...
Refer to the documentation below, which is also available in every site's INI template. For more information on how to control BOA on site level via INI files, check our [documentation](https://github.com/omega8cc/boa/blob/5.x-pro/docs/ini/site/INI.md).
