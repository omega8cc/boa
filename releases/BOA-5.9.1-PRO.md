...
## New BOA-5.9.1 PRO/LTS Release
  ...
  intense development from the DEV branch, delivering 321 commits packed
 ...
 * HTTP/3 and KTLS support. If you run Drupal sites that should feel fast and
   ...
   Why is this a big deal? What should visitors notice? [**Read the full story!**](https://github.com/omega8cc/boa/tree/5.x-lts/HTTP3.md)
...
## Going Local with Infrastructure
  ...
  **Montreal**, **Calgary**, and **Vancouver**.
  ...
  In Australia, it’s no longer just **Sydney** — we also offer **Adelaide**,
  **Brisbane**, and **Perth**.
