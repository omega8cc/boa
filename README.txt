...
* PHP-FPM 5.3.21 with APC, phpredis, uploadprogress and ionCube.
...
Octopus can install the platforms listed below:
 ...
 Open Deals 1.17 -------------- http://opendealsapp.com
 Open Outreach 1.0-rc9 -------- http://openoutreach.org
