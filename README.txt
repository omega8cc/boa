...
Octopus can install and/or support the platforms listed below:
 ...
 Drupal 7.79.1 ---------------- https://drupal.org/project/drupal/releases/7.79
 ...
 @ Pressflow (D6 LTS included, thanks to myDropWizard) 6.56.2

 Commons 2.27 ----------------- https://drupal.org/project/commons
 Pressflow 6.56.2 ------------- http://pressflow.org
 Ubercart 2.15 ---------------- https://drupal.org/project/ubercart

* All D7 platforms have been enhanced using Drupal 7.79.1 +Extra core:
  https://github.com/omega8cc/7x/tree/7.x-om8

* All D6 platforms have been enhanced using Pressflow (LTS) 6.56.2 +Extra core:
