...
Octopus can install and/or support the platforms listed below:
 ...
 Varbase 9.0.3 ---------------- https://drupal.org/project/varbase

 @ Drupal 8

 Social 10.3.2 ---------------- https://drupal.org/project/social

 @ Drupal 7.82.3

 Commerce 1.68 ---------------- https://drupal.org/project/commerce_kickstart
 Commerce 2.71 ---------------- https://drupal.org/project/commerce_kickstart
 Drupal 7.82.3 ---------------- https://drupal.org/project/drupal/releases/7.82
 ...
 Opigno LMS 1.53 -------------- https://drupal.org/project/opigno_lms
 Panopoly 1.83 ---------------- https://drupal.org/project/panopoly
 Ubercart 3.13 ---------------- https://drupal.org/project/ubercart

 @ Pressflow (D6 LTS included, thanks to myDropWizard) 6.59.1

 Pressflow 6.59.1 ------------- http://pressflow.org
 Ubercart 2.15 ---------------- https://drupal.org/project/ubercart

* All D7 platforms have been enhanced using Drupal 7.82.3 +Extra core:
  https://github.com/omega8cc/7x/tree/7.x-om8

* All D6 platforms have been enhanced using Pressflow (LTS) 6.59.1 +Extra core:
