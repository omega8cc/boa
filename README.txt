...
* PHP-FPM 5.3.14 with APC, phpredis, uploadprogress, suhosin and ionCube.
...
Octopus can install the platforms listed below:
 ...
 CiviCRM 4.1.3-d6 ------------- http://civicrm.org
 CiviCRM 4.1.3-d7 ------------- http://civicrm.org
 Commerce 1.8.1 --------------- http://drupalcommerce.org
 Commons 2.7 ------------------ http://acquia.com/drupalcommons
 ...
 OpenChurch 1.10-alpha3 ------- http://openchurchsite.com
 OpenPublic 1.0-beta3 --------- http://openpublicapp.com
 OpenPublish 3.0-alpha9 ------- http://openpublishapp.com
