...
Octopus can install and/or support the platforms listed below:
 ...
 Drupal 7.64.1 ---------------- https://drupal.org/project/drupal/releases/7.64
 ...
 OpenOutreach 1.52 ------------ https://drupal.org/project/openoutreach
 ...
 Pressflow 6.47.1 ------------- http://pressflow.org
 Ubercart 2.15 ---------------- https://drupal.org/project/ubercart

* All D7 platforms have been enhanced using Drupal 7.64.1 +Extra core:
  https://github.com/omega8cc/7x/tree/7.x-om8

* All D6 platforms have been enhanced using Pressflow 6.47.1 +Extra core:
