...
Octopus can install and/or support the platforms listed below:
 ...
 aGov 3.6 --------------------- https://drupal.org/project/agov
 Commerce 1.48 ---------------- https://drupal.org/project/commerce_kickstart
 Commerce 2.48 ---------------- https://drupal.org/project/commerce_kickstart
 Commons 3.45 ----------------- https://drupal.org/project/commons
 Drupal 7.56.1 ---------------- https://drupal.org/project/drupal/releases/7.56
 Guardr 2.38 ------------------ https://drupal.org/project/guardr
 OpenAid 2.8 ------------------ https://drupal.org/project/openaid
 OpenAtrium 2.617 ------------- https://drupal.org/project/openatrium
 OpenChurch 2.2 --------------- https://drupal.org/project/openchurch
 OpenLucius 1.7 --------------- https://drupal.org/project/openlucius
 OpenOutreach 1.41 ------------ https://drupal.org/project/openoutreach
 OpenPublic 1.12 -------------- https://drupal.org/project/openpublic
 Opigno LMS 1.26 -------------- https://drupal.org/project/opigno_lms
 Panopoly 1.46 ---------------- https://drupal.org/project/panopoly
