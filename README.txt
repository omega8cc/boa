...
Octopus can install and/or support the platforms listed below:
 ...
 Commerce 2.43 ---------------- https://drupal.org/project/commerce_kickstart
 Commons 3.42 ----------------- https://drupal.org/project/commons
 Drupal 7.54.1 ---------------- https://drupal.org/project/drupal/releases/7.54
...
* All D7 platforms have been enhanced using Drupal 7.54.1 +Extra core:
